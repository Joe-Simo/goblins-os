...
check "capture harness uses documented QMP absolute pointer range" "rg -q 'ABS_MAX = 0x7fff' os/hardware-gate/capture-harness/drive-capture.py os/hardware-gate/capture-harness/qmp-capture.py && rg -q 'abs_axis(value)' os/hardware-gate/capture-harness/drive-capture.py os/hardware-gate/capture-harness/qmp-capture.py && ! rg -q '0x7fffffff|32767' os/hardware-gate/capture-harness/drive-capture.py os/hardware-gate/capture-harness/qmp-capture.py"
