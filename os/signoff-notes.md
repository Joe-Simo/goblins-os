...
- Current project completion status: incomplete for release-ready signoff. The 2026-06-16 sandbox-reproducible gates passed for that source/image snapshot, but the current project now requires fresh native aarch64 and x86_64 ISO artifacts, per-architecture SHA256/manifests/SBOMs, display-backed installer/desktop/settings/gaming/storage screenshots, a real runtime engine build artifact, and complete architecture-specific signoff rows. Do not treat this historical sandbox run as current shipping completion.
...
- Release evidence that is now explicitly recorded:
  ...
  - `os/release/release-readiness-delta.toml` now records `dual_arch_rpm_sbom_present`; this closes the local x86_64 RPM SBOM proof gap without claiming x86_64 ISO or hardware proof.
...
- Multi-agent quality audit (6 dimensions x adversarial per-finding verification) confirmed the system is otherwise high-quality (installer "recovery grade, no blocker/major"; settings "all 38 panels real builders, no defect at the bar"; honesty/security "at/above the macOS bar, secrets server-side only"). Applied 7 confirmed findings + 1 evidence fix; deferred 1 with rationale:
...
- Hardware gate after placing the x86_64 shippable ISO: 285 PASS / 18 FAIL (was 273/29). The 18 remaining = aarch64 shippable manifest/BIB (flips when the aarch64 CI rerun lands) + the 28-shot GPU/Vulkan/gaming screenshot runs + close-signoff motion/gaming rows for both arches — the genuine real-hardware-GPU-display core, unreproducible on headless CI or this host.
...
## Manual Gate Run: 2026-07-04T161149Z (script assisted)
- Runner: GitHub Actions 1000009275 (Linux/X64, hardware-gate-capture, https://github.com/Joe-Simo/goblins-os/actions/runs/28710819638)
- CI workflow references: verified in-repo at .github/workflows/build.yml
- Architecture: x86_64
- CI run IDs/URLs:
  - rust: https://github.com/Joe-Simo/goblins-os/actions/runs/28710819638
  - image: https://github.com/Joe-Simo/goblins-os/actions/runs/28710819638
  - installer-iso: https://github.com/Joe-Simo/goblins-os/actions/runs/28710819638
- Image: ghcr.io/joe-simo/goblins-os:x86_64
- ISO: os/iso/output/x86_64/bootiso/goblins-os-x86_64.iso
- ISO SHA256: d1b4ea4e56214868186d5e658e9151e398b27d78a56776d55c20ade230609a11
...
- Runtime engine run:
  ...
  - config path/artifact: os/screenshots/hardware-gate/x86_64/2026-07-03/runtime-build-proof.json
  - built artifact path/URL: os/screenshots/hardware-gate/x86_64/2026-07-03/runtime-build-proof.json
- Motion/interactions checked: yes (light/dark screenshots present in proof dir)
- Firewall live toggle checked: yes (firewall-live-toggle-proof.json: disable=200/inactive, enable=200/active)
- Text Shortcuts session enablement checked: yes (text-shortcuts-session-enable-proof.json: service/source/engine active; core reports live runtime readiness)
- Text Shortcuts live keystrokes checked: yes (covered by text-shortcuts-live-ibus-runtime-render-proof.json + 32-text-shortcuts-live-ibus-runtime-render.png: normal expansion, pass-through, password refusal, focused-field callback, text-input-v3 commit, and rendered accept bubble)
...
## Manual Gate Run: 2026-07-04T221319Z (script assisted)
- Runner: GitHub Actions 1000009294 (Linux/X64, hardware-gate-capture, https://github.com/Joe-Simo/goblins-os/actions/runs/28720230809)
- CI workflow references: verified in-repo at .github/workflows/build.yml
- Architecture: x86_64
- CI run IDs/URLs:
  - rust: https://github.com/Joe-Simo/goblins-os/actions/runs/28720230809
  - image: https://github.com/Joe-Simo/goblins-os/actions/runs/28720230809
  - installer-iso: https://github.com/Joe-Simo/goblins-os/actions/runs/28720230809
- Image: ghcr.io/joe-simo/goblins-os:x86_64
- ISO: os/iso/output/x86_64/bootiso/goblins-os-x86_64.iso
...
- CI run IDs/URLs:
  - rust: https://github.com/Joe-Simo/goblins-os/actions/runs/28727099426
  - image: https://github.com/Joe-Simo/goblins-os/actions/runs/28727099426
  - installer-iso: https://github.com/Joe-Simo/goblins-os/actions/runs/28727099426
- Image: ghcr.io/joe-simo/goblins-os:aarch64
- ISO: os/iso/output/aarch64/bootiso/goblins-os-aarch64.iso
- ISO SHA256: 539fe24454f5cf1b0bb3ac00c9b8a838614ada85a310511fb9605afa978686a7
- Rootfs verify command:   docker run --rm ghcr.io/joe-simo/goblins-os:aarch64 /usr/libexec/goblins-os/goblins-os-verify --installed-root /
- Verify result (blocked=0): pass
- Self-test command: DOCKER_BUILDKIT=1 docker buildx build -f /tmp/selftest.Dockerfile --target selftest --output type=cacheonly .
- Self-test log: /tmp/goblins-os-selftest.log
- Self-test result: pass
- Rootfs verify output: /tmp/goblins-os-verify.log
- Release evidence/SBOM checked: yes (manifest, diligence links, Cargo TSV, and RPM TSV present in os/signoff-proofs/sbom/aarch64)
- Screenshot dir: os/screenshots/hardware-gate/aarch64/2026-07-05
- Runtime engine run:
  - mode: local-model
  - engine source: local-gpt-oss-built
  - config path/artifact: os/screenshots/hardware-gate/aarch64/2026-07-05/runtime-build-proof.json
  - built artifact path/URL: os/screenshots/hardware-gate/aarch64/2026-07-05/runtime-build-proof.json
- Motion/interactions checked: yes (light/dark screenshots present in proof dir)
- Firewall live toggle checked: yes (firewall-live-toggle-proof.json: disable=200/inactive, enable=200/active)
- Text Shortcuts session enablement checked: yes (text-shortcuts-session-enable-proof.json: service/source/engine active; core reports live runtime readiness)
- Text Shortcuts live keystrokes checked: yes (covered by text-shortcuts-live-ibus-runtime-render-proof.json + 32-text-shortcuts-live-ibus-runtime-render.png: normal expansion, pass-through, password refusal, focused-field callback, text-input-v3 commit, and rendered accept bubble)
