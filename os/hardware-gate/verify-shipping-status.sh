...
check "capture harness proves Text Shortcuts session plumbing without runtime claim" "rg -q '/proof/text-shortcuts-session-enable' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'org.goblins.OS.IBus.service' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'ibus engine goblins-textshortcuts' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'ensure_textshortcuts_ibus_component' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'wait_ibus_cli_ready' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'user_component_seeded=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'list_error=' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'IBUS_COMPONENT_PATH=%h/.local/share/ibus/component:/usr/share/ibus/component' os/systemd-user/org.goblins.OS.IBus.service && rg -q 'ExecStartPre=-/usr/bin/ibus write-cache' os/systemd-user/org.goblins.OS.IBus.service && rg -q 'Type=dbus' os/systemd-user/org.goblins.OS.IBus.service && rg -q 'BusName=org.freedesktop.IBus' os/systemd-user/org.goblins.OS.IBus.service && rg -q '/var/home/goblin/.local/share/ibus/component/goblins-textshortcuts.xml' os/bootc/Containerfile && rg -q 'core_runtime_loop_available=false' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'runtime_ready_claim=false' os/hardware-gate/capture-harness/in-session-orchestrator.sh"
