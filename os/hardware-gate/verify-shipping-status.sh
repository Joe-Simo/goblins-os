...
check "hardware gate requires Audio output proof" "rg -q 'audio-output-proof.json' os/hardware-gate/capture-harness/drive-capture.py os/hardware-gate/capture-harness/run-capture.sh os/hardware-gate/close-signoff.sh os/hardware-gate/verify-shipping-status.sh os/hardware-gate/runbook.md && rg -q '/proof/audio-output' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q '/v1/audio/status' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'pw-play' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/bootc/Containerfile && rg -q 'GOBLINS_OS_CAPTURE_EXPECT_TITLE=\"Goblins OS Settings - Sound\"' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -Fq 'GOS_SHOT_WINDOW_WAIT_ATTEMPTS=\"\${GOS_AUDIO_SHOT_WINDOW_WAIT_ATTEMPTS:-8}\"' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -Fq 'GOS_SHOT_HELPER_TIMEOUT_SECONDS=\"\${GOS_AUDIO_SHOT_HELPER_TIMEOUT_SECONDS:-1}\"' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -Fq 'one_second = bytearray()' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -Fq 'for _ in range(seconds):' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q '24-audio-output.png' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/hardware-gate/capture-harness/run-capture.sh os/hardware-gate/close-signoff.sh os/hardware-gate/verify-shipping-status.sh && rg -q 'Audio output checked' os/hardware-gate/close-signoff.sh os/hardware-gate/verify-shipping-status.sh"
