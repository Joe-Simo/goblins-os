...
check "IME menu-bar input source render hook is source-gated" "rg -q '59-menubar-input-source-\$suffix.png' os/bootc/render-desktop.sh && rg -Fq \"[('xkb', 'us'), ('xkb', 'gb')]\" os/bootc/render-desktop.sh && rg -q 'gsettings set org.gnome.desktop.input-sources current 1' os/bootc/render-desktop.sh"
...
check "menu-bar Focus render hook is source-gated" "rg -q '59b-menubar-focus-\$suffix.png' os/bootc/render-desktop.sh && rg -Fq '[{\"id\":\"work\",\"name\":\"Deep Work\"}]' os/bootc/render-desktop.sh && rg -q 'gsettings set org.goblins.os.focus active-mode work' os/bootc/render-desktop.sh"
...
check "core app privacy exposes allowlisted revoke route" "rg -q '/v1/app-privacy/revoke' crates/goblins-os-core/src/main.rs && rg -q 'PermissionStore.DeletePermission' crates/goblins-os-core/src/app_permissions.rs && rg -q 'permission_id_is_safe' crates/goblins-os-core/src/app_permissions.rs"
...
check "capture harness proves Text Shortcuts session plumbing without runtime claim" "rg -q '/proof/text-shortcuts-session-enable' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'org.goblins.OS.IBus.service' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'ibus engine goblins-textshortcuts' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'ensure_textshortcuts_ibus_component' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'user_component_seeded=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'list_error=' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'IBUS_COMPONENT_PATH=%h/.local/share/ibus/component:/usr/share/ibus/component' os/systemd-user/org.goblins.OS.IBus.service && rg -q 'ExecStartPre=-/usr/bin/ibus write-cache' os/systemd-user/org.goblins.OS.IBus.service && rg -q '/var/home/goblin/.local/share/ibus/component/goblins-textshortcuts.xml' os/bootc/Containerfile && rg -q 'core_runtime_loop_available=false' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'runtime_ready_claim=false' os/hardware-gate/capture-harness/in-session-orchestrator.sh"
...
check "Text Shortcuts one-shot input source seed is source-gated" "test -x os/input/goblins-os-input-source-seed && rg -q 'input-source-seeded' os/input/goblins-os-input-source-seed && rg -q 'gsettings set org.gnome.desktop.input-sources sources' os/input/goblins-os-input-source-seed && rg -q 'gsettings set org.freedesktop.ibus.general preload-engines' os/input/goblins-os-input-source-seed && rg -q 'COPY --chmod=0755 os/input/goblins-os-input-source-seed /usr/libexec/goblins-os/goblins-os-input-source-seed' os/bootc/Containerfile && rg -q 'bash -n /usr/libexec/goblins-os/goblins-os-input-source-seed' os/bootc/Containerfile && rg -q 'Wants=org.goblins.OS.InputSourcesSeed.service' os/systemd-user/gnome-session@goblins-os.target.d/goblins-os.session.conf && rg -q 'Before=org.goblins.OS.IBus.service' os/systemd-user/org.goblins.OS.InputSourcesSeed.service && rg -q 'After=gnome-session-initialized.target org.gnome.Shell@user.service org.goblins.OS.InputSourcesSeed.service' os/systemd-user/org.goblins.OS.IBus.service"
check "capture harness proves Text Shortcuts live keystrokes through focused GTK fields" "rg -q '/proof/text-shortcuts-live-keystroke' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof normal' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof password' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof dismiss' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof passthrough' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'host_type_text normal-omw \"omw\\.\"' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'host_type_text passthrough-hello \"hello\\.\"' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'host_press_key dismiss-escape Escape' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'TEXT_SHORTCUTS_INPUT_DRIVER=qmp-keyboard' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q '/input/text/' os/hardware-gate/capture-harness/drive-capture.py && rg -q '/input/key/' os/hardware-gate/capture-harness/drive-capture.py && rg -q 'password_refusal=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'dismiss_no_commit=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'passthrough_unchanged=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh"
...
check "capture harness drives Text Shortcuts live IBus runtime/render proof" "rg -q '/proof/text-shortcuts-live-ibus-runtime-render' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q -- '--text-shortcuts-proof live-runtime-render' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'GOBLINS_TEXTSHORTCUTS_PROOF_EVENTS' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'systemctl --user set-environment GOBLINS_TEXTSHORTCUTS_PROOF_EVENTS' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-textshortcuts-live-ibus-runtime-render' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/hardware-gate/capture-harness/run-capture.sh && rg -q '32-text-shortcuts-live-ibus-runtime-render.png' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/hardware-gate/capture-harness/run-capture.sh os/hardware-gate/close-signoff.sh os/hardware-gate/verify-shipping-status.sh && rg -q 'focused_field_callback' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/hardware-gate/capture-harness/run-capture.sh && rg -q 'text_input_v3_commit' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/hardware-gate/capture-harness/run-capture.sh && rg -q 'rendered_accept_bubble' os/hardware-gate/capture-harness/in-session-orchestrator.sh os/hardware-gate/capture-harness/run-capture.sh && rg -q 'rendered_bubble_ready_claim=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'live_overlay_claim=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'runtime_ready_claim=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'core_readiness_flip=deferred' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q '\"core_readiness_flip\": \"deferred\"' os/hardware-gate/capture-harness/run-capture.sh && ! rg -q 'live-ibus-runtime-render-not-implemented' os/hardware-gate/capture-harness/in-session-orchestrator.sh"
