...
check "capture harness proves Text Shortcuts live keystrokes through focused GTK fields" "rg -q '/proof/text-shortcuts-live-keystroke' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof normal' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof password' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'goblins-os-shell\" --text-shortcuts-proof dismiss' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'wtype -- \"omw\\.\"' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'wtype -P Escape -p Escape' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'password_refusal=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'dismiss_no_commit=true' os/hardware-gate/capture-harness/in-session-orchestrator.sh"
