...
check "installed self-test checks firewall status and honest toggle route" "rg -q '/v1/firewall/status' os/bootc/run-selftest.sh && rg -q '/v1/firewall/enabled' os/bootc/run-selftest.sh && rg -Fq '502|503) [ \"\$firewall_toggle_ok\" = \"false\" ]' os/bootc/run-selftest.sh"
