...
check "hardware gate records App privacy seed fallback diagnostics" "rg -q 'plain_permissions' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'seed_attempt=' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'seed_error=' os/hardware-gate/capture-harness/in-session-orchestrator.sh && rg -q 'proof_query_value' os/hardware-gate/capture-harness/in-session-orchestrator.sh"
